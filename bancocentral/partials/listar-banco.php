	...
	<tbody>
		<?php $sql = "SELECT * FROM bc_bancos";
			...
			<tr>
				...
				<td>
					<a class="btn btn-warning" href="index.php?pagina=cadastro-banco&id=<?=$bancos['id']?>">Editar</a>
					<a class="btn btn-danger" href="php/deletar.php?tabela=bancos&id=<?=$bancos['id']?>&voltar=listar-banco">Deletar</a>
				</td>
			</tr>
		<?php } ?>
	</tbody>
